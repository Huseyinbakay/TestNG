...
public class Listeners implements ITestListener , IRetryAnalyzer, IAnnotationTransformer {
    ...
    //Bu method Fail olan testleri kaç defa daha çalıştırabildiğimi söyleyebilgiğim methoddur.Yalnız başına kullanılmıyor.Aşağıda yazıldı
    ...
    /*
    Bu method yukarıdaki methoda yardımcı bir methoddur
     */
